                        ...
                        @foreach ($klub as $item)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <form action="{{ route('klub-destroy', $item->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')

                                        <a href="{{ route('klub-edit', $item->id) }}"
                                        ...
                                        <button type="submit"
                                            class="focus:outline-none bg-red-600 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Hapus</button>
                                    </form>
                                </td>
